    ...
    <section class="border border-gray-200 rounded-xl overflow-hidden min-h-full flex flex-col">
      <header class="flex items-center justify-between px-4 py-3 border-b border-gray-200">
        ...
        <div class="flex items-center space-x-4 text-gray-600 text-sm font-normal">
          ...
          <div aria-label="User initial G" class="w-8 h-8 rounded-full bg-purple-700 text-white flex items-center justify-center font-semibold text-sm">G</div>
        </div>
      </header>
      ...
      <div class="flex flex-1">
        <nav class="w-44 border-r border-gray-200 bg-blue-50 rounded-bl-xl">
          <ul class="py-2">
            <li>
              <button class="flex items-center w-full px-4 py-3 text-gray-900 text-sm font-normal hover:bg-blue-100">
            ...
            <li class="border-t border-gray-200">
              <div class="flex flex-col">
                <button class="flex items-center justify-between w-full px-4 py-3 text-gray-900 text-sm font-normal hover:bg-blue-100 group" id="teaching-btn">
                  <div class="flex items-center">
                    <i class="fas fa-chalkboard-teacher text-blue-600 w-5 mr-3 text-center"></i>
                    <span>Teaching</span>
                  </div>
                  <i class="fas fa-chevron-down text-xs text-gray-500 group-hover:text-gray-700 transform transition-transform duration-200" id="teaching-arrow"></i>
                </button>
                <div class="pl-4 hidden" id="teaching-dropdown">
                  <button class="flex items-center w-full px-4 py-2 text-gray-900 text-xs font-normal hover:bg-blue-100">
                    <i class="fas fa-eye text-gray-500 w-5 mr-3 text-center"></i>
                    <span>To Review</span>
                  </button>
                  <button class="flex items-center w-full px-4 py-3 text-gray-900 text-xs font-normal hover:bg-blue-100">
        ...
        <div class="flex-1 flex flex-col">
            <div class="flex space-x-4 p-4 border-b border-gray-200">
                <a href="/guru" class="px-6 py-2 rounded-full border border-blue-400 bg-blue-300 text-blue-900 text-sm font-normal">
                Stream
                </a>
                <a href="/guru_create" class="px-6 py-2 rounded-full border border-gray-400 text-gray-900 text-sm font-normal">
                Classwork
                </a>
                <a href="/guru_people" class="px-6 py-2 rounded-full border border-gray-400 text-gray-900 text-sm font-normal">
                People
                </a>
                <a href="#grades" class="px-6 py-2 rounded-full border border-gray-400 text-gray-900 text-sm font-normal">
                Grades
                </a>
            </div>
          <div class="p-6 flex-1">
            <div class="bg-blue-400 rounded-lg p-6 mb-6">
            ...
            <div class="flex items-center bg-white border border-gray-300 rounded-lg px-4 py-3 space-x-4">
              <div class="flex items-center justify-center rounded-full bg-purple-700 text-white w-8 h-8 text-sm font-semibold">
                G
              </div>
              <input class="flex-1 text-xs text-gray-600 placeholder-gray-600 focus:outline-none" placeholder="Announce Something to your class ..." type="text"/>
