            ...
            <div class="flex flex-1">
                ...
                <div class="flex-1 flex flex-col">
                    <div class="flex space-x-4 p-4 border-b border-gray-200">
                        ...
                        <a href="{{ route('elearning.teacher.grades.student-work') }}"
                    ...
                    <div class="px-6 py-4">
                        <article class="flex items-center space-x-4">
                            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-yellow-400 text-white">
                            ...
                            <div>
                                ...
                                <time class="block text-xs text-gray-600 mt-2">
                                    16 May 2020 5:00 pm
                                </time>
