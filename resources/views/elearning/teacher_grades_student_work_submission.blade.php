                    ...
                    <ul class="py-2">
                        ...
                        <li class="border-t border-gray-200">
                            <div class="flex flex-col">
                                ...
                                <div class="pl-4" id="teaching-dropdown">
                                    <button
                                        class="flex items-center w-full px-3 py-2 text-gray-900 text-xs font-normal hover:bg-blue-100 rounded-lg teaching-class-btn bg-blue-100">
                                        <div
