...
<body class="bg-white text-black w-full min-h-screen flex flex-col">
            ...
            <div class="flex flex-1">
                ...
                <div class="flex-1 flex flex-col">
                    <div class="flex space-x-4 p-4 border-b border-gray-200">
                        ...
                        <a href="/guru_create"
                            class="px-6 py-2 rounded-full border border-blue-400 text-blue-900 text-sm font-normal">
                            Classwork
                        </a>
                        <a href="/guru_people"
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <button aria-label="Add teacher" class="text-gray-600 hover:text-gray-800">
